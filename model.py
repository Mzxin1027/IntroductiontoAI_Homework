...
class ImprovedResNet(nn.Module):
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False, use_se=False):
...
def ImprovedResNet50(num_classes=10, use_se=False):
    return ImprovedResNet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes, use_se=use_se)